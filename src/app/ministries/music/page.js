      ...
      <section className="max-w-7xl mx-auto py-24 px-6 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="pt-10 flex justify-between border-t border-gray-100">
            <Link href="/ministries/family" className="text-gray-400 hover:text-red-700 flex items-center gap-2 text-xs font-bold uppercase tracking-widest transition-colors">
              <ChevronLeftCircleIcon size={16} /> Family
            </Link>
            <Link href="/ministries/global" className="text-gray-400 hover:text-red-700 flex items-center gap-2 text-xs font-bold uppercase tracking-widest transition-colors">
        ...
        <aside className="lg:col-span-4">
          <div className="bg-gray-50 border-t-4 border-red-700 p-8 shadow-sm">
            <h4 className="text-xl font-serif mb-6 flex items-center gap-2">
              <Disc className="text-red-700 animate-spin" style={{ animationDuration: '3s' }} size={20} />
              Latest Tracks
            </h4>
              ...
              {tracks.map((track, i) => (
                <div key={i} className="flex items-center justify-between p-3 bg-white border border-gray-100 group hover:border-red-700 transition-all cursor-pointer">
                  <div className="flex items-center gap-3">
                    <Play size={14} className="text-red-700 opacity-0 group-hover:opacity-100 transition-opacity" fill="currentColor" />
      ...
      {isVideoOpen && (
        <div className="fixed inset-0 z-[100] bg-black/95 flex items-center justify-center p-4 md:p-10">
          ...
          <div className="w-full max-w-5xl aspect-video relative">
            ...
            >
              <source src="https://res.cloudinary.com/dnxnr4ocz/video/upload/v1769430190/Every_Worship_Song_in_under_a_MINUTE_-_Caleb_Kelsey_1080p_h264_wv4vmh.mp4" type="video/mp4" />
