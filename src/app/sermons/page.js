  ...
  return (
    <main className="bg-[#F9F6F0] min-h-screen">
      ...
      <section className="relative h-[65vh] flex items-center justify-center bg-[#0a1227]">
        <div className="absolute inset-0 opacity-40 bg-[url('https://res.cloudinary.com/dnxnr4ocz/image/upload/v1769420773/sermon-hero_mjkpdl.png')] bg-cover bg-center"></div>
      ...
      <section className="max-w-7xl mx-auto -mt-20 px-6 relative z-20">
        <div className="bg-white shadow-2xl flex flex-col lg:flex-row overflow-hidden">
          <div className="lg:w-2/3 relative group cursor-pointer">
            <img
              src="https://res.cloudinary.com/dnxnr4ocz/image/upload/v1769420692/latest-sermon_sko33h.png"
