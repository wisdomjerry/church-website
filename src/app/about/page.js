...
export default function AboutPage() {
  const team = [
    ...
    },
    {
      ...
      img: "https://res.cloudinary.com/dnxnr4ocz/image/upload/v1769349036/pastor_Matthew_gnyjms.webp",
    },
    {
      name: "Pr Boyi Gerald",
      role: "Assistant Pastor",
      img: "https://res.cloudinary.com/dnxnr4ocz/image/upload/v1769349670/pastor_Gerald_asmd1b.jpg",
    },
    { name: "Dickon Sera", role: "Dickon", img: "/Jackson.png" },

    {
      name: "Pr Lubuulwa Stephen",
      role: "Youth Pastor",
      img: "https://res.cloudinary.com/dnxnr4ocz/image/upload/v1769353206/David_j3s2zq.png",
    },
    {
      name: "Pr Jordan",
      role: "Assistant Pastor",
      img: "https://res.cloudinary.com/dnxnr4ocz/image/upload/v1769353223/Emma_xtlawz.png",
    },
  ];
    ...
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="bg-[#fffbf0] px-6 relative pt-24">
        <div className="max-w-6xl mx-auto">
          {/* Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch relative min-h-[600px]">
            {/* LEFT SIDE: Content */}
              ...
              <FadeUp>
                <div className="h-full flex items-end justify-center">
                  <img
                    ...
                    alt="Pastor"
                    className="w-full max-w-[450px] h-full object-contain object-bottom"
                  />
                </div>
              </FadeUp>
            </div>
      ...
      <section className="  bg-[#fffbf0] px-6 pt-15 pb-24">
        <FadeUp>
