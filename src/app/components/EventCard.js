...
export default function EventCard({ title, date, time, image }) {
  ...
  return (
    /* FIXED: Changed rounded-sm to rounded-xl and added overflow-hidden */
    <div className="bg-white rounded-xl overflow-hidden shadow-sm group hover:shadow-2xl transition-all duration-300 relative flex flex-col h-[55vh] border border-gray-100">
      {/* Top Section: Increased height from h-52 to h-64 to push content down */}
      ...
      {/* Bottom Section: Details - Adjusted padding to make it feel lower */}
      <div className="p-8 pt-10 flex flex-col flex-1 bg-white">
        ...
        {/* Push the "Read More" link to the very bottom */}
